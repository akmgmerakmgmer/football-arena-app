  ...
  @override
   void paint(Canvas canvas, Size size) {
    ...
    final shadowPaint = Paint()
      ..color = Colors.red.shade600.withOpacity(0.6) // Shadow color with opacity
    ...
    path.lineTo(size.width * 0.85, size.height); // Bottom-right slant
    path.lineTo(size.width * 0.15, size.height); // Bottom-left slant
    path.close();
